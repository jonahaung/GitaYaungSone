...
public class AutoCompleteTextField: UITextField {
    ...
    struct Constants {
        static let DefaultButtonWidth: CGFloat = 30.0
        static let DefaultButtonHeight: CGFloat = 30.0
    }
    ...
    weak internal var actfDataSource: AnyObject? {
        didSet {
    ...
    fileprivate func performDomainSuggestionsSearch(_ queryString: String) -> AutoCompleteData? {
        
        guard let dataSource = dataSource else { return processSourceData([], queryString: queryString) }
    ...
    fileprivate func processSourceData(_ dataSource: [AutoCompleteData], queryString: String) -> AutoCompleteData? {
    ...
    fileprivate func performTextCull(domain: AutoCompleteData, stringFilter: String) -> String {
    ...
    fileprivate func updateAutocompleteLabel(domain: AutoCompleteData?, originalString stringFilter: String) {
